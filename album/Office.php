    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-4">
          <h4>About</h4>
          <p class="text-body-secondary">ร้านขายอุปกรณืและของใช้ภายในบ้าน</p>
        </div>
        <div class="col-sm-4 offset-md-1 py-4">
          <h4>ADMIN</h4>
          <ul class="list-unstyled">
            <li><?=$_SESSION['aname'];?></li>
            <li><a href="customer.php" class="text-white">สมาชิก</a>
             <li><a href="order.php" class="text-white">รายการสั่งซื้อ</a>
            <li><a href="logout.php" class="text-white">ออกจากระบบ</a>
            </li>
          </ul>
        </div>
      </div>
...
<main>
  ...
  <section class="py-5 text-center container">
    ...
    <img src="images/0.jpg" height="150" width="150"></a>
        <h1 class="fw-light">รายการสินค้า</h1>
        <p class="lead text-body-secondary">ร้านขายอุปกรณ์ตกแต่งบ้านครบจบที่เดียว</p>
        <p>
  ...
  <div class="album py-5 bg-body-tertiary">
    <div class="container">
	  ...
	  @$kw = $_POST['search'];
	  $sql = "SELECT * FROM Office WHERE (p_name LIKE '%{$kw}%' OR p_detail LIKE '%{$kw}%')";
	  ...
	  ?>
        <div class="col">
          <div class="card shadow-sm">
            <img src="images/<?=$data['p_id'];?>.<?=$data['p_picture'];?>"width="100%" 
            height="250"> 
            <div class="card-body">
              <p class="card-text">
              <?=$data['p_name'];?><br>
              ...
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <a href="update.php?pid=<?=$data['p_id'];?>"type="button" class="btn btn-sm btn-info">แก้ไข</a>
                  <a href="delete.php?pid=<?=$data['p_id'];?>&ext=<?=$data['p_picture'];?>"onClick="return comfirm('ยืนยันการลบ?')";"type="button" class="btn btn-sm btn-danger">ลบ</a>
                </div>
              </div>
            </div>
          </div>
